...
struct Emoji: Codable {
    ...
    static let archiveURL = documentsDirectory.appendingPathComponent("emojis_data").appendingPathExtension("plist")
    ...
    static func loadFromFile() -> [Emoji]? {
        ...
        let decodedEmojis = try? propertyListDecoder.decode([Emoji].self, from: retrievedEmojis) {
